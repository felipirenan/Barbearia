...
public class  ValidaSenhas_  {
	...
	public boolean ComparaHash(String senhaAtual, String senhaNova) throws NoSuchAlgorithmException, UnsupportedEncodingException {
		
		//String senhaNovaHash = HashSenha(senhaNova);
		System.out.println(senhaAtual + "    " + senhaNova );
